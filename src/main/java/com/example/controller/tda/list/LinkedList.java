...
public class LinkedList<E> implements Iterable<E> {
    ...
    public Iterator<E> iterator() {
        return new Iterator<E>() {
            private Node<E> current = header; // Comienza desde el primer nodo

            @Override
            public boolean hasNext() {
                return current != null; // Si el nodo actual no es nulo, hay más elementos
            }
            ...
            public E next() {
                ...
                E data = current.getInfo(); // Obtiene el valor del nodo actual
